...
const projects = [
  {
    ...
    fullDescription: 'Сюжет фильма «Кукушка»: После переезда в новый дом молодой человек встречает свою соседку, а вскоре начинает замечать что-то странное. Герой пытается найти объяснение происходящей мистике, которая связана со страшной тайной отца его новой знакомой. «Кукушка» (2024) — якутский мистический фильм режиссера Евгения Николаева, основанный на его короткометражном дебюте.',
    year: '2023',
    ...
    awards: [
      'Лучший фильм ужасов, Фестиваль независимого кино 2023',
      'Специальный приз жюри, Московский кинофестиваль 2023'
    ],
    filmCrew: [
